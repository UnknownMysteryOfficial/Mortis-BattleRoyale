...
public class MatchLeaveBr implements CommandExecutor {

    private final MortisBattleRoyale plugin;

    public MatchLeaveBr(MortisBattleRoyale plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        String tpWorldName = config.getString("battleroyale.tp-world");
